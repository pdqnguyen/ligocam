...
<html lang="en" class="no-js">
    <head>
        ...
        <title>LigoCAM @ LHO | PEM main</title>
        <link rel="stylesheet" type="text/css" href="css/style.css" />
    </head>
    
    <body>
        <div class="header" style="color:white; background-color:#7FA009;">
                  <h1>LigoCAM @ LHO | PEM </h1>
        </div>

        <div class="boxedmid">
            <form action="https://ldas-jobs.ligo.caltech.edu/~philippe.nguyen/test/ligocam_test/LigoCAM/PEM/LigoCamHTML_current.html" target="_blank">
                ...
                foreach($years as $year) {
                    ...
                    foreach($months as $num => $month) {
                        ...
                        if (in_array($datestring, $hide)) {
                            ...
                            $url = "https://ldas-jobs.ligo.caltech.edu/~philippe.nguyen/test/ligocam_test/LigoCAM/PEM/calendar/LigoCAM_" . $datestring . ".html";
                            $color = $colors[$year];
                            $bgcolor = $bgcolors[$year];
                            echo "\t\t\t\t";
